...
-- Add bid_id column to deposit_transactions table if it doesn't exist
ALTER TABLE deposit_transactions
ADD COLUMN IF NOT EXISTS bid_id UUID REFERENCES bids(id);

-- Add deposit fields to bids table if they don't exist
ALTER TABLE bids 
...
-- Create a function to calculate bid deposit amount if it doesn't exist
