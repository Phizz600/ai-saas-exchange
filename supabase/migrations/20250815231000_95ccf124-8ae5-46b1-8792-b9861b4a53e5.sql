-- Fix the handle_new_user function to resolve JSON/JSONB conversion error
-- This is causing signup failures with "COALESCE could not convert type json to jsonb"
...
AS $function$
DECLARE
  raw_user_meta jsonb;  -- Changed from json to jsonb
  raw_user_type text;
  first_name_val text;
  last_name_val text;
BEGIN
