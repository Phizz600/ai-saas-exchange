...
export const MarketplaceStats = () => {
  ...
  return <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 md:gap-6">
      {/* Revenue spans 2 columns on larger screens */}
      <div className="col-span-2 lg:col-span-1">
        <RevenueCard value={stats?.totalRevenue || 0} averagePerProduct={stats?.averageRevenuePerProduct || 0} change={stats?.revenueChange} />
      </div>
      <div className="col-span-1">
        <ProductsCard value={stats?.productCount || 0} activeCount={stats?.activeProductCount || 0} change={stats?.productCountChange} />
      </div>
      <div className="col-span-1">
