...
export const StatsCard = ({ title, value, change, subtitle, icon, chartData, chartColor = "hsl(var(--primary))" }: StatsCardProps) => {
  return (
    <Card className="p-4 md:p-6 hover:shadow-xl hover:shadow-primary/20 hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300 ease-out h-full group">
      <div className="flex h-full">
        ...
        {chartData && chartData.length > 0 && (
          <div className="w-20 md:w-24 ml-4 flex items-center">
