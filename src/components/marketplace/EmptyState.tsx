...
export function EmptyState() {
  ...
  return <motion.div className="flex flex-col items-center justify-center py-16 px-4 text-center" initial={{
    opacity: 0,
    y: 20
  }} animate={{
    opacity: 1,
    ...
    duration: 0.5
      ...
      <p className="max-w-md mb-8 text-white">
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <Button variant="outline" className="bg-white shadow-sm hover:shadow-md" onClick={handleRefresh}>
          <RefreshCw className="h-4 w-4 mr-2" />
          Refresh
        </Button>
        
        <Button className="bg-gradient-to-r from-[#D946EE] via-[#8B5CF6] to-[#0EA4E9] hover:opacity-90">
