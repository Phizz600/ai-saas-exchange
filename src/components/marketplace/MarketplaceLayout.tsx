...
export const MarketplaceLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col overflow-x-hidden">
      <Header />
      <main className="flex-grow w-full mt-16 overflow-x-hidden">
        {/* Hero Section with Background Gradient */}
        <div className="relative bg-gradient-to-r from-[#D946EE]/10 via-[#8B5CF6]/10 to-[#0EA4E9]/10 py-12">
            ...
            <motion.div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8" initial="hidden" animate="visible" variants={fadeIn}>
              ...
              <div className="flex gap-2 w-full md:w-auto justify-end">
                <Link to="/product-dashboard" className="hidden sm:block">
                  <Button variant="outline" className="shadow-sm hover:shadow-md transition-shadow whitespace-nowrap">
                    <LayoutDashboard className="mr-2 h-4 w-4" />
                    Dashboard
                  </Button>
                </Link>
                <Link to="/list-product" className="w-full sm:w-auto">
                  <Button className="w-full sm:w-auto bg-gradient-to-r from-[#D946EE] via-[#8B5CF6] to-[#0EA4E9] hover:shadow-lg transition-all hover:opacity-90 border-0">
