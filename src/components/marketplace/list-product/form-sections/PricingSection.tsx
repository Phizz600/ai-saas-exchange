    ...
    <Card className="w-full">
      <CardContent className="p-6">
        <div className="space-y-6">
          ...
          {valuation.low > 0 && valuation.high > 0 && (
            <div className="p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border border-green-200">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  type="button"
                  onClick={() => handleValuationClick(valuation.low)}
                  className="px-3 py-2 bg-green-100 hover:bg-green-200 text-green-800 rounded-md text-sm font-medium transition-colors"
                >
                  {formatCurrency(valuation.low)} (Conservative)
                </button>
                <button
                  type="button"
                  onClick={() => handleValuationClick(valuation.high)}
                  className="px-3 py-2 bg-blue-100 hover:bg-blue-200 text-blue-800 rounded-md text-sm font-medium transition-colors"
                >
