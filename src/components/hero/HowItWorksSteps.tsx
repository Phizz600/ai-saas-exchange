const HowItWorksSteps = () => {
  return <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-0 my-0 py-[20px]">
        <div style={{
        animationDelay: '0.1s'
      }} className="bg-white/10 backdrop-blur-sm p-6 rounded-lg transform transition-all duration-300 hover:scale-105 hover:bg-white/15 animate-fade-in-up px-[23px] my-0">
