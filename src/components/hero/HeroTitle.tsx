...
const HeroTitle = ({
  ...
  return <motion.div initial={{
    ...
    duration: 0.3
      ...
      <h1 className="exo-2-heading font-bold leading-tight text-white text-center text-3xl md:text-5xl my-0 mx-0 py-0 w-full max-w-xs sm:max-w-md md:max-w-5xl px-4 sm:px-8 md:px-[84px]">
