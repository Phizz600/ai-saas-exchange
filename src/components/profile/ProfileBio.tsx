...
export const ProfileBio = ({
  ...
  return <Card className="animate-fade-in">
      ...
      <CardContent className="space-y-4">
        {editing ? <>
            <Textarea value={newBio} onChange={e => setNewBio(e.target.value.slice(0, maxChars))} placeholder="Tell others about yourself and your expertise..." className="min-h-[100px] resize-none" />
