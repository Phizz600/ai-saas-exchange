            ...
            <Sheet>
              ...
              <SheetContent side="left" className="w-[300px] bg-[#EBEFF1] flex flex-col">
                ...
                <div className="mt-auto mb-6">
                  <Button onClick={e => handleNavigationClick(e, '/list-product')} className="w-full bg-gradient-to-r from-[#D946EE] via-[#8B5CF6] to-[#0EA4E9] text-white hover:opacity-90" variant="secondary">Sell Your AI SaaS Business</Button>
                </div>
              </SheetContent>
            </Sheet>
          </div>
