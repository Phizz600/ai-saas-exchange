...
export const Navbar = () => {
  ...
  const navigationItems = [
    { title: "Buy an AI Business", href: "/auth", requiresAuth: false },
    { title: "AI Business Valuation", href: "/listproduct", requiresAuth: true },
    { title: "About", href: "/about", requiresAuth: false },
    { title: "Dashboard", href: "/product-dashboard", requiresAuth: true }
  ];
